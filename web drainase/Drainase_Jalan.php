  ...
  <section id="peta" class="features">
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" id="yossudarso-tab" data-toggle="tab" href="#yossudarso" role="tab"
          aria-controls="yossudarso" aria-selected="true">Yos Sudarso</a>

        <a class="nav-item nav-link" id="type6-tab" data-toggle="tab" href="#type6" role="tab" aria-controls="type6"
          aria-selected="false">Type 6</a>

        <a class="nav-item nav-link" id="paus-tab" data-toggle="tab" href="#paus" role="tab" aria-controls="paus"
          aria-selected="false">Paus</a>

        <a class="nav-item nav-link" id="sukamaju-tab" data-toggle="tab" href="#sukamaju" role="tab"
          aria-controls="sukamaju" aria-selected="false">Suka Maju</a>

        <a class="nav-item nav-link" id="lembahdamai-tab" data-toggle="tab" href="#lembahdamai" role="tab"
          aria-controls="lembahdamai" aria-selected="false">Lembah Damai</a>
      </div>
    </nav>
