...
var vectorLayer = new ol.layer.Vector({
  ...
  var container = document.getElementById('popupsukamaju'),
    content_element = document.getElementById('popup-contentsukamaju'),
    closer = document.getElementById('popup-closersukamaju');
