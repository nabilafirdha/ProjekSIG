...
var vectorLayer = new ol.layer.Vector({
  ...
  var container = document.getElementById('popuppaus'),
    content_element = document.getElementById('popup-contentpaus'),
    closer = document.getElementById('popup-closerpaus');
