...
var vectorLayer = new ol.layer.Vector({
  ...
  var container = document.getElementById('popuptype'),
    content_element = document.getElementById('popup-contenttype'),
    closer = document.getElementById('popup-closertype');
