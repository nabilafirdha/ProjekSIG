    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Data Drainase Berdasarkan Lokasi Tersumbat/ Banyak Sampah</h1>
        </div>
  ...
  <section id="peta" class="features">
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" id="datats-tab" data-toggle="tab" href="#datatersumbat" role="tab" aria-controls="datatersumbat" aria-selected="true">Data Tersumbat</a>
    </nav>

    <div class="container-fluid" data-aos="fade-up">
      <div class="tab-content" id="nav-tabContent">
        <!-- Data Banjir -->
        <div class="tab-pane fade show active" id="datatersumbat" role="tabpanel" aria-labelledby="databj-tab">
          <div class="wrap">
            <div class="badan">
          ...
          <script type="text/javascript">
            ...
            $(document).ready(function() {
              var table = $('#datatersumbat').DataTable({
                responsive: true,
                "ajax": {
                  "type": "POST",
